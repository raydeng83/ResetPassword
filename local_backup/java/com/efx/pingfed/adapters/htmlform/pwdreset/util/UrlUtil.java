...
public class UrlUtil
{
  ...
  public String buildSelectMethodUrl() {
    return getContextPath() + "/ext/pwdreset/SelectMethod";
  }

  public String buildSelectMethodUrl(String username) {
    return getContextPath() + "/ext/pwdreset/SelectMethod?username=" + username;
  }
