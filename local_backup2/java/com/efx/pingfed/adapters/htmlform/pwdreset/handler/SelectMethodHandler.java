...
public class SelectMethodHandler extends BaseHandler
{
    ...
    public SelectMethodHandler(PasswordManagementConfiguration configuration) {
        super(configuration);
    }
    ...
    public IdentifyResult validateUsername(IdentifyForm identifyForm, HttpServletRequest request, HttpServletResponse response) {
        ...
        for (String pcvId : this.configuration.getPcvIds())
        {
            try
            {
                logger.info("Username found in the form data is " + identifyForm.getUsername());
        ...
        else
        {
            ...
            // }
            String adapterIdQueryParam = this.configuration.getAdapterId();
